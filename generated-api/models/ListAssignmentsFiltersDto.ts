...
/* tslint:disable */
/* eslint-disable */
export type ListAssignmentsFiltersDto = {
    owner?: string;
    client?: string;
    name?: string;
    description?: string;
    branch?: ListAssignmentsFiltersDto.branch;
    minPayment?: number;
    maxPayment?: number;
    status?: ListAssignmentsFiltersDto.status;
    assignmentDeadline?: string;
    trailDate?: string;
};
export namespace ListAssignmentsFiltersDto {
    export enum branch {
